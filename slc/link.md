...
| `resumableStateIds` | Exact delegated-player state ids registered as resumable by the FSM's interrupt/jump contract; no script, final or other non-player state. Do not add states the declared interrupt contract does not permit. |
