...
function readDecisionReply(
  ...
  switch (action) {
    ...
    case 'switch': {
      ...
      return {
        selection: { action, playbookId, input: parsed.input as string },
      };
    }
    case 'dismiss': {
...
async function runDecisionState(
  ...
  return { ...selection, guard: selection.action, settlement } as CaptainOutput;
}
