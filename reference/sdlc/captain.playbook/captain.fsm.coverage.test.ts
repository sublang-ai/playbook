...
// Generated by slc (DR-009): FSM transition coverage for "captain".
import { readFileSync } from 'node:fs';
import { fileURLToPath } from 'node:url';

import { describe, expect, it } from 'vitest';

import { checkFsmCoverage, fsmCoverageTestTimeout } from "./.slc-verify/verify.js";
import * as fsm from "./captain.fsm.js";

describe("captain: FSM coverage", () => {
