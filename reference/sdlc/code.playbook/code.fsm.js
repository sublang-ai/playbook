...
export const codingMachine = setup({
    ...
    states: {
            ...
            invoke: {
                ...
                input: ({ context }) => ({
                    ...
                    result: {
                        ...
                        challengesRaised: 'Coder challenged one or more review items. Output shall include `challenges: <numbered rebuttals, one per challenged item>`.',
        ...
        reviewChangesSpecs: {
            ...
            description: 'CODE-11: Reviewer reviews uncommitted Coder changes that touch only @specs/{user,dev,test}/.',
            invoke: {
                src: 'captain',
                input: () => ({
                    player: 'Reviewer',
        ...
        reviewChangesCode: {
            ...
            description: 'CODE-12: Reviewer reviews uncommitted Coder changes that touch only files outside @specs/{user,dev,test}/.',
            invoke: {
                src: 'captain',
                input: () => ({
                    player: 'Reviewer',
        ...
        reviewChangesMixed: {
            ...
            description: 'CODE-13: Reviewer reviews uncommitted Coder changes that touch both @specs/{user,dev,test}/ and other files.',
            invoke: {
                src: 'captain',
                input: () => ({
                    player: 'Reviewer',
        ...
        commitCoderInitial: {
            ...
            description: 'CODE-15: Committer commits Coder Initial Changes when Reviewer has not played since the last commit.',
            invoke: {
                src: 'captain',
                input: ({ context }) => ({
                    player: 'Committer',
        ...
        commitReviewerCleared: {
            ...
            description: 'CODE-16: Committer commits changes Reviewer cleared in the same round when Coder has not played since the last commit.',
            invoke: {
                src: 'captain',
                input: ({ context }) => ({
                    player: 'Committer',
        ...
        commitJoint: {
            id: 'commitJoint',
            description: 'CODE-17: Committer commits changes when both Coder and Reviewer have played since the last commit.',
            invoke: {
                src: 'captain',
                input: ({ context }) => ({
                    player: 'Committer',
