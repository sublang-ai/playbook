...
describe('enumerateCaptainStates', () => {
  ...
  it('pins per-state transition counts (sentinel — bumps require updating this list)', () => {
    ...
    expect(counts).toEqual({
      ...
      continueIr: 3,
      summarizeSpecs: 3,
      reviewBossCommitSpecs: 5,
      reviewBossCommitCode: 5,
      reviewBossCommitMixed: 5,
      reviewIrTaskCommitSpecs: 5,
      reviewIrTaskCommitCode: 5,
      reviewIrTaskCommitMixed: 5,
      reviewChangesSpecs: 3,
      reviewChangesCode: 3,
      reviewChangesMixed: 3,
      reviewChangesAndChallengesSpecs: 3,
      reviewChangesAndChallengesCode: 3,
      reviewChangesAndChallengesMixed: 3,
      adjudicateChallenges: 6,
      commitCoderInitial: 9,
      commitJoint: 6,
    });
  });
});
