...
export const devPlaybookRegistryEntry = {
    id: 'dev',
    command: 'dev',
    intent: 'plan the development path for a request: direct implementation, or a durable decision first, delivered through a pull request when the request names a GitHub issue or asks for one',
    artifactSchema: 3,
