...
- The Spex desktop app now draws running playbooks natively in its Captain pane — live statechart cards folded from the runtime's `playbook.trace` telemetry, with the machine graph served over its own protocol — recorded there as its DR-028 [[1]].
...
[1]: https://github.com/sublang-ai/spex/blob/main/specs/decisions/028-run-machine-view.md "Spex DR-028 — run machines drawn"
