...
3. **A retained generation may cross sessions under an exact structural envelope and single-transfer ownership.**
   ...
   A store-owned record that fresh discovery cannot validate or resume likewise leaves predecessor ordering unproved, so the launch diagnoses and preserves it, publishes an empty target, and does not fall through to older work.
