...
# DR-059: Helper-Backed Compact Linking Recipe
...
The optional materializer of [DR-058](058-link-materialization-tool.md) removes repetitive output generation.
...
Keep the materializer's independent retention decision under [DR-058](058-link-materialization-tool.md) pending its own controlled baseline evidence.
