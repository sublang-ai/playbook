...
# IR-066: Compact Link Definition
...
Evaluate the compact-definition performance technique and retain it only with measured successful compilation evidence, as recorded in [DR-053](../decisions/053-compact-link-definition.md).
