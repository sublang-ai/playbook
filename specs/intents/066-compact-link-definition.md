...
Evaluate the compact-definition performance technique and retain it only with measured successful compilation evidence, as recorded in [DR-060](../decisions/060-compact-link-definition.md).
