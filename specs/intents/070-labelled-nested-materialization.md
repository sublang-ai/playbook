...
Evaluate a bounded extension of the optional materializer in [DR-058](../decisions/058-link-materialization-tool.md) for the labelled string relays and nested calls of CODE and DEV, preserving their authored FSMs and the full link contract.
