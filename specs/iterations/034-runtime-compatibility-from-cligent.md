...
- [x] DR-027 records the delegation and the clauses of DR-026 it
      supersedes; PBCLI-39, PBCLI-40, PBCLI-41, RELEASE-12, and RELEASE-27
...
1. [x] **Record the delegation.**
       Record DR-027; amend PBCLI-39 for the descriptor-derived map and the
       end of `gemini`'s exemption, PBCLI-40 for the unsupported verdict and
       pinned remedies, PBCLI-41 for their test counterparts, RELEASE-12 to
