...
- [x] `views/sketch/src/sketch.ts` — exports values `mountSketch`, `extractGraph`, `renderSketch`, `renderSketchToString`, `applySketchTelemetry`, `fromXStateActor`, `fromEventSource`; exports types `SketchTelemetry`, `SketchSource`, `SketchGraph`.
