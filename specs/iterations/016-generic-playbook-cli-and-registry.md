...
- [x] CODE registry entry reshaped to the DR-009 §1 manifest, and the shell generalized to read park states, summary policy, and role binding from the active entry rather than hardcoding CODE specifics.
