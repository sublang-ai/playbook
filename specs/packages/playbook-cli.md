...
For a numerically initialized writer, before assigning a sequence or writing, `append` shall require a supplied role to be a nonempty string and shall require the sanitized record projection to be a non-null, non-array JSON object satisfying `ReplayRecord`; either failure shall reject the append promise, write no bytes, leave both numeric sequence boundaries unchanged, and enter the live latch-and-stop state of [[playbook-cli-76](#playbook-cli-76)].
...
| Facade append boundary | On a numerically initialized lease, a JavaScript primitive, a JSON-safe array, a non-object-projecting object such as `Date`, and a valid record paired with an empty or non-string role shall each reject only to the caller before sequence assignment or writing, leave the file and both sequence boundaries unchanged, set `incomplete: true`, suppress a later valid append, and write no diagnostic; a successor lease shall accept the unchanged clean prefix with no inherited latch and reuse the unconsumed next sequence ([[playbook-cli-73](#playbook-cli-73)], [[playbook-cli-75](#playbook-cli-75)], [[playbook-cli-76](#playbook-cli-76)], [[playbook-cli-83](#playbook-cli-83)], [[playbook-cli-84](#playbook-cli-84)]). |
