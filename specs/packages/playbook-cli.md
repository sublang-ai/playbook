...
Before runtime work, continuation shall also validate the shared replay/context boundary and path compatibility [[session-storage-4](session-storage.md#session-storage-4)] [[session-storage-9](session-storage.md#session-storage-9)].
