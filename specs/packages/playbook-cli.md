...
A skipped store-owned record shall leave predecessor ordering unproved, so initial discovery or an authoritative rescan shall publish the intentional empty target strictly after every valid same-working-directory boundary it can observe without falling through to older retained work.
