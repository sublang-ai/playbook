...
| --- | --- |
| `text2gears.md` | `c2fb447a4a3a4708ac75d4cba7364748260a32b6a33ef970dee4a5c79233be56` |
...
The builder shall recover the exact published text-to-GEARS bytes by removing only its two-sentence common authored-relay clarification, excluding the separate Results-boundary experiment from both arms.
...
| --- | --- | --- |
| `text2gears` | Both Spex grammars and lock | `gears2fsm.md`, `link.md`, `optimize.md` |
