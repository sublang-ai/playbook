...
The suite shall fail unless descendant source-option drift remains installable under current enabled options, a transient construction failure with successful cleanup remains re-installable, and a preparation or installation cleanup rejection installs no partial offer and closes unsafe shell reuse (verifying [[playbook-captain-46](#playbook-captain-46)]).
