...
The shell shall never copy a capability member, callback, lease token, or repository identity into configured options, frame state, the player ledger, a shell or runtime snapshot, a retained generation, or continuation comparison.
