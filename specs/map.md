...
| [DR-040](decisions/040-outcome-authority-effect-reconciliation.md) | 040-outcome-authority-effect-reconciliation.md | CODE, REVIEW, and DECIDE field authority, per-outcome repository predicates, durable no-replay reconciliation, unresolved-effect disposal outside the terminal variant, and structured Captain evidence |
