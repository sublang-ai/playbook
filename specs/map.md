...
| [DR-038](decisions/038-universal-run-resumption.md) | 038-universal-run-resumption.md | Resumption as a capability-gated machine property — retained pre-terminal generations with their nested stacks, cross-session adoption under an exact structural envelope, ledger-authoritative players, Captain resume selection, and DR-040's clear on unresolved abandonment |
