...
| [DR-028](decisions/028-empty-ok-result-re-ask.md) | 028-empty-ok-result-re-ask.md | One corrective re-ask on an empty `ok` player or direct-Captain result before failure-sink routing, limited by DR-040 to non-effectful or durably proved-zero calls |
...
| [DR-040](decisions/040-outcome-authority-effect-reconciliation.md) | 040-outcome-authority-effect-reconciliation.md | CODE, REVIEW, and DECIDE presentation, semantic, repository-effect, and runtime-settlement authority with durable no-replay reconciliation and structured Captain evidence |
