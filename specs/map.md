...
| [DR-015](decisions/015-per-run-agent-tuning.md) | 015-per-run-agent-tuning.md | Repeatable `--with <path>` top-level config overlays for new interactive and headless Captain sessions, with continuation retaining its frozen lineup |
