...
| [DR-009](decisions/009-generic-playbook-cli-and-registry.md) | 009-generic-playbook-cli-and-registry.md | Generic `playbook` CLI and registry manifests, explicit modules, inline agent config, static namespaced fallbacks, effective nested bindings and visibility, frame-owned summaries, and current CODE/REVIEW/DECIDE starter enablement |
...
| [DR-019](decisions/019-shared-linked-runtime-factory.md) | 019-shared-linked-runtime-factory.md | The generic single-region FSM interpreter ships once as `createXStatePlaybookRuntime(machine, spec)` on `@sublang/playbook/xstate-runtime`; CODE and REVIEW use the thin profile, while parallel DECIDE remains bespoke |
