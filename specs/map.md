...
| DR-009 | [009-generic-playbook-cli-and-registry.md](decisions/009-generic-playbook-cli-and-registry.md) | Generic `playbook` CLI and multi-playbook registry enablement: built-in CODE default plus `from`-loaded registry modules, profile-based agent settings, playbook-scoped namespaced players, registry-owned park states and summary policy, CODE preset compatibility, and one active engagement preserved |
